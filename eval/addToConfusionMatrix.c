...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "core.eval.addToConfusionMatrix", 
        "sources": [
            "addToConfusionMatrix.pyx"
        ]
    }, 
    "module_name": "core.eval.addToConfusionMatrix"
}
END: Cython Metadata */
...
static const char __pyx_k_core_eval_addToConfusionMatrix[] = "core.eval.addToConfusionMatrix";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "core.eval.addToConfusionMatrix")) {
      if (unlikely(PyDict_SetItemString(modules, "core.eval.addToConfusionMatrix", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                    np.ndarray[np.uint64_t, ndim=2] confMatrix      ,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4core_4eval_20addToConfusionMatrix_1cEvaluatePair, NULL, __pyx_n_s_core_eval_addToConfusionMatrix); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init core.eval.addToConfusionMatrix", 0, __pyx_lineno, __pyx_filename);
    }
